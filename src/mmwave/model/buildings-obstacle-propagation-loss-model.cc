...
namespace ns3
{
	...
	static const double g_blockage_down[9766] = {
		// Aditya's trace for SINR drop due to blockage
		-0.143156,
		-0.305271,
		-0.445706,
		-0.521129,
	...
	static const double g_blockage_up[9766] = {
		// Aditya's trace for SINR raise after a blockage
		-44.626535,
		-41.484524,
		-35.542639,
		-33.064564,
