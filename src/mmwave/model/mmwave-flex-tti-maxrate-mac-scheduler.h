...
namespace ns3
{
	...
	private:
		...
		struct FlowStats
		{
			...
			FlowStats(bool uplink, UeSchedInfo *ueSchedInfo, uint8_t lcid) : m_isUplink(uplink), m_ueSchedInfo(ueSchedInfo),
		...
		struct UeSchedInfo
		{
			UeSchedInfo() : m_rnti(0), m_dlMcs(0), m_ulMcs(0), m_maxDlBufSize(0),
			...
			UeSchedInfo(uint16_t rnti) : m_rnti(rnti), m_dlMcs(0), m_ulMcs(0), m_maxDlBufSize(0),
										 m_maxUlBufSize(0), m_maxDlSymbols(0), m_maxUlSymbols(0),
										 m_dlSymbols(0), m_ulSymbols(0),
										 m_dlSymbolsRetx(0), m_ulSymbolsRetx(0),
										 m_dlTbSize(0), m_ulTbSize(0),
		...
		struct UlCqiMapElem
		{
			UlCqiMapElem(std::vector<double> ulCqi, uint8_t nSym, uint32_t tbs) : m_ueUlCqi(ulCqi), m_numSym(nSym), m_tbSize(tbs)
			{
			}
		...
		struct AllocMapElem
		{
			AllocMapElem(std::vector<uint16_t> rntiMap, uint8_t nSym, uint32_t tbs) : m_rntiPerChunk(rntiMap), m_numSym(nSym), m_tbSize(tbs)
			{
			}
