...
void MmWavePropagationLossModel::SetMinLoss(double minLoss)
{
	m_minLoss = minLoss;
}
double
...
void MmWavePropagationLossModel::UpDataScenarioMap()
{
	m_channelScenarioMap.clear();
	Simulator::Schedule(Seconds(1), &MmWavePropagationLossModel::UpDataScenarioMap, this);
}

void MmWavePropagationLossModel::SetConfigurationParameters(Ptr<MmWavePhyMacCommon> ptrConfig)
{
