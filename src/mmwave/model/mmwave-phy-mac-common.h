...
namespace ns3
{
	...
	{
		DlDciInfoElementTdma() : m_symStart(0), m_numSym(0), m_mcs(0),
	...
	struct DciInfoElementTdma
	{
		...
		DciInfoElementTdma() : m_rnti(0), m_format(0), m_symStart(0), m_numSym(0), m_mcs(0),
							   m_tbSize(0), m_ndi(0), m_rv(0), m_harqProcess(0)
		{
		}

		DciInfoElementTdma(uint16_t rnti, uint8_t format, uint8_t symStart, uint8_t numSym, uint8_t mcs,
						   uint32_t tbs, uint8_t ndi, uint8_t rv, uint8_t harqProc) : m_rnti(rnti), m_format(format), m_symStart(symStart), m_numSym(numSym), m_mcs(mcs),
	...
	struct SlotAllocInfo
	{
		...
		SlotAllocInfo(uint8_t slotIdx, TddMode tddMode, TddSlotType slotType, CtrlTxMode ctrlTxMode, uint16_t rnti) : m_tddMode(tddMode), m_isOmni(0), m_slotType(slotType),
